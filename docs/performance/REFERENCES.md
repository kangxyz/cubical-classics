# Agda Performance References

This document records upstream Agda performance reports that match local
profiling symptoms. Use it as background when [the runbook](RUNBOOK.md) points
at an unfamiliar bucket.

## GitHub Matches

The upstream Agda issue tracker has several reports that match symptoms seen
in this repository:
