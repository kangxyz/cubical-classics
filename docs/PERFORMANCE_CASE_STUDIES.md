...
This document records fixed Agda performance case studies for this repository.
Use `docs/PERFORMANCE.md` for the triage workflow, common slow patterns,
open slow files, and upstream references.

Add new entries here after a slow check is understood and verified.  Keep
unfinished diagnostics in `Open Slow Files` in `docs/PERFORMANCE.md`.
