...
- Dedekind cuts over an Archimedean ordered field form a MacNeille-complete
  ordered field;
...
- `Classical/DedekindCut/` contains the cut construction, its algebra and
  order, the ordered-field instance, MacNeille completeness of cuts, and the
  universal property.
