...
`Constructive.CauchyReals` contains the HoTT Book-style Cauchy reals.  The
main real type is the `Constructive.Analysis.CauchyCompletion` instance for
the rational metric space, generated by rationals, limits of precision-indexed
Cauchy approximations, and separatedness paths, together with the
rational-indexed closeness relation.
