{- The product-of-sums theorem for majorized Cauchy products. -}
{-# OPTIONS --safe --lossy-unification #-}
module Constructive.Analysis.Reals.Series.CauchyProduct.ProductOfSums where
