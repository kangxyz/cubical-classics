...
The canonical map from Cauchy reals to Dedekind reals

-}
{-# OPTIONS --safe #-}
module Constructive.Analysis.Reals.CauchyToDedekind where
...
import Constructive.Analysis.Completions.DedekindCompletion.Base as DedekindCompletion
...
private
  module D = DedekindCompletion.CompletionBase ℚLinearlyOrderedField
