...
module Constructive.Analysis.Reals.PowerSeries.Differentiation.SubballConvergence where
...
open import Constructive.Analysis.Reals.PowerSeries.Differentiation.SubballEstimate
...
derivativeStrictSubballTailBoundFromOnBall
  ...
  μ1≤sucm+j j =
    NatOrder.≤-trans (μ1≤m+j j) NatOrder.≤-sucℕ

  shiftpedTerm≤Majorant :
    (j : ℕ) →
    absᶜ (shift m derivativeTerms j) ≤ᶜ shift m majorant j
  shiftpedTerm≤Majorant j =
