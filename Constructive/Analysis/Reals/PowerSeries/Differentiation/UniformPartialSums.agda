...
module Constructive.Analysis.Reals.PowerSeries.Differentiation.UniformPartialSums where
...
open import Constructive.Analysis.Reals.Calculus.SecondOrderRemainder
  using (boundedSecondDerivativeHasDerivativeAtWithFromSecondBound)
