...
module Constructive.Analysis.Reals.PowerSeries.Elementary.Logarithm.FunctionalEquation.LogOnePlusDerivative where
...
open import Constructive.Analysis.Reals.PowerSeries.Differentiation.MajorizedSecondDerivativeBounds
  using
