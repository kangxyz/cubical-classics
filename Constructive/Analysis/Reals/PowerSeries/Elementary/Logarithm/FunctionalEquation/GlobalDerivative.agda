...
module Constructive.Analysis.Reals.PowerSeries.Elementary.Logarithm.FunctionalEquation.GlobalDerivative where
...
logᶜ-positive-window lo hi x window =
  logᶜ x (positiveWindowDomain lo hi x window)
...
logᶜ-data-independent :
  ...
  logᶜ x left ≡
  logᶜ x right
logᶜ-data-independent x left right =
  cong
    (twoᶜ ·ᶜ_)
  ...
  where
  leftData =
    logTransformSubunitDataFromPositiveBoundedᶜ x left

  rightData =
    logTransformSubunitDataFromPositiveBoundedᶜ x right
  ...
  leftRadius =
    subunitRadius leftData

  rightRadius =
    subunitRadius rightData

  leftRadius<1 =
    subunitRadius<1 leftData

  rightRadius<1 =
    subunitRadius<1 rightData

  leftTransformBound : BoundedByᶜ leftRadius leftTransform
  leftTransformBound =
    subunitBound leftData

  rightTransformBound : BoundedByᶜ rightRadius rightTransform
  rightTransformBound =
    subunitBound rightData
