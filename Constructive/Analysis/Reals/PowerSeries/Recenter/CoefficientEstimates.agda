...
module Constructive.Analysis.Reals.PowerSeries.Recenter.CoefficientEstimates where
...
open import Constructive.Data.PositiveRationals
  using (ℚ⁺ ; radius ; _*⁺_ ; posInv⁺ ; ratio⁺ ; ratio⁺<1)
...
recenterCoefficientWeight≤Scale δ σ δ<σ n k =
  ...
  ratio-path =
    ...
    cong
      (B ℚ.·_)
      (ratioPowerTimesPositivePower δ σ k)
