...
module Constructive.Analysis.Reals.PowerSeries.Recenter.Convergence where
...
open import Constructive.Analysis.Reals.PowerSeries.Recenter.GeometricBounds
  using (binomialGeometricBoundScale ; binomialGeometricBoundScale≥1)
open import Constructive.Analysis.Reals.PowerSeries.Recenter.CoefficientEstimates
  using
    ( recenterCoefficientScale
    ; recenterCoefficientWeight≤Scale
    )
open import Constructive.Analysis.Reals.PowerSeries.Recenter.Majorants
open import Constructive.Data.PositiveRationals
  using (ℚ⁺ ; radius ; posInv⁺ ; ratio⁺ ; ratio⁺<1)
...
private
  ...
  strictSubballCoefficientMajorTail {a = a} {δ = δ} {σ = σ} {v = v} {ν = ν}
    ...
    scaled-shift-tail :
      TailBound
        (λ k → rational scale ·ᶜ shift n v k)
