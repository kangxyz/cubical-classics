...
Finite strip estimates for strict-subball re-centering.

-}
{-# OPTIONS --safe --lossy-unification #-}
module Constructive.Analysis.Reals.PowerSeries.Recenter.StripFinite where
...
open import Constructive.Analysis.Reals.CauchyReals.Order.Bounded
  using (BoundedByᶜ ; bounded-byᶜ ; upperᶜ)
...
open import Constructive.Analysis.Reals.PowerSeries.Recenter.Binomial
  using (binomialᶜ ; binomialᶜ-natural ; binomialℕ ; triangularRowsSumᶜ)
