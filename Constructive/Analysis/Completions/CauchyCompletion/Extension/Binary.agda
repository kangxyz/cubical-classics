...
-}
{-# OPTIONS --safe #-}
module Constructive.Analysis.Completions.CauchyCompletion.Extension.Binary where
...
open import Constructive.Analysis.Completions.CauchyCompletion.Extension.Nonexpanding
...
module BinaryExtensionOf (𝓜 : MetricSpace ℓ ℓ') where
  open CompletionOf 𝓜
  open ClosenessOf 𝓜
  open ComputedOf 𝓜
  ...
  open NonexpandingExtensionOf 𝓜
  open UniquenessOf 𝓜
  open InductionOf 𝓜
